// this will only be used if I decide to use Jave Database Connectivity instead of Hibernate
...
//				String url = "jdbc:postgresql://localhost:5432/postgres?currentSchema=Krusty_Krab"; **only do it like this if not doing environment variables
...
//				String url = System.getenv("url");//jdbc:postgresql://localhost:5432/postgres?currentSchema="P1Demo"
